...
<div class="margin add_administrator" id="page_style">
    ...
    <form action="../updatenotice.do" method="post" id="form-admin-add">
    <ul>
     <li class="clearfix">
			<label class="label_name col-xs-2 col-lg-2">公告：</label>
			<div class="formControls col-xs-6">
				<textarea name="discrpie" cols="" rows="" class="textarea col-xs-12" placeholder="说点什么...100个字符以内" dragonfly="true" onkeyup="checkLength(this);"><c:out value="${notice }"></c:out></textarea>
