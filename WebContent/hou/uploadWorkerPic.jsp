...
<div class="margin add_administrator" id="page_style">
    ...
    <form action="../uploadworkerpicture.do" method="post" id="form-admin-add">
    <ul>
    	 <li class="clearfix">
		<label class="label_name col-xs-2 col-lg-2">员工id：</label>
			<input type="text" name="workerid" id="workerid" value="${workerid }"  readonly="readonly"/> 
		</li>
     
		 <li class="clearfix">
		<label class="label_name col-xs-2 col-lg-2">上传照片：</label>
			<p><input type="text" name="workerpic" id="url1" value="" /> <input type="button" name="workerpic" id="image1" value="选择图片" />（网络图片 + 本地上传）</p>
		</li>
         <li class="clearfix">
