...
<div class="margin add_administrator" id="page_style">
    ...
    <form action="../addworkertype.do" method="post" id="form-admin-add">
    <ul>
     <li class="clearfix">
     <label class="label_name col-xs-2 col-lg-2"><i>*</i>职位名：</label>
     <div class="formControls col-xs-6">
     <input type="text" class="input-text col-xs-12" value="" placeholder="" id="workertypename" name="workertypename" datatype="*2-8" nullmsg="职位名不能为空" ajaxurl="../workertypecheck.do"></div>
    <div class="col-4"> <span class="Validform_checktip"></span></div>
     </li>
     <li class="clearfix">
			<label class="label_name col-xs-2 col-lg-2">描&nbsp;述：</label>
			<div class="formControls col-xs-6">
