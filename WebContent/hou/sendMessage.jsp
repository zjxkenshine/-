...
<div class="margin add_administrator" id="page_style">
    ...
    <ul>
     <li class="clearfix">
      <label class="label_name col-xs-2 col-lg-2"><i class="c-red">*</i>发送给：</label>
      <div class="formControls col-xs-6"> <span class="select-box" style="width:150px;">
				<select class="select" name="tomanager" size="1" datatype="*" nullmsg="选择接收人">
					<option value="">选择接收人员</option>
