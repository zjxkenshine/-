...
<div class="list_Exhibition margin-sx">
 <table class="table table_list table_striped table-bordered" id="sample-table">
  ...
  <tbody>
  <c:forEach items="${jobcollect }" var="jc">
    <tr class="main">
   	  	<td class="center"><label><input btn_name="checkid" type="checkbox" class="ace" value=""><span class="lbl"></span></label></td>
   		<td><c:out value="${jc.getCollectId() }"></c:out></td>
   		<td><c:out value="${jc.getJobId() }"></c:out></td>
   		<td><c:out value="${jobname.get(jc.getJobId()) }"></c:out></td>
   		<td><c:out value="${jc.getClientId() }"></c:out></td>
   		<td><c:out value="${clientname.get(jc.getClientId()) }"></c:out></td>
   		<td><c:out value="${jc.getAddTime() }"></c:out></td>
   	</tr>
  </c:forEach>
  </tbody>
 </table>
