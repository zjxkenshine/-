...
<div class="margin add_administrator" id="page_style">
    ...
    <form action="../addworker.do" method="post" id="form-admin-add">
    <ul>
     <li class="clearfix">
     <label class="label_name col-xs-2 col-lg-2"><i>*</i>员工姓名：</label>
     <div class="formControls col-xs-6">
     <input type="text" class="input-text col-xs-12" value="" placeholder="" id="workername" name="workername" datatype="*2-8" nullmsg="员工名不能为空" ajaxurl="../checkworker.do"></div>
    <div class="col-4"> <span class="Validform_checktip"></span></div>
     </li>
     <li class="clearfix">
      <label class="label_name col-xs-2 col-lg-2"><i class="c-red">*</i>身份证号：</label>
      <div class="formControls col-xs-6">
		<input type="text" class="input-text col-xs-12" name="idcard" id="idcard" datatype="idcard" nullmsg="请输入身份证号！" ajaxurl="../checkworker.do" >
	   </div>
		<div class="col-4"> <span class="Validform_checktip"></span></div>
     </li>
     <li class="clearfix">
      ...
      <div class="formControls col-xs-6">
		<input type="text" class="input-text col-xs-12"  name="tel" id="tel" datatype="m" nullmsg="请输入正确的电话号码！" ajaxurl="../checkworker.do" >
	   </div>
		<div class="col-4"> <span class="Validform_checktip"></span></div>
     </li>
     <li class="clearfix">
      ...
      <div class="formControls col-xs-6">
		<input type="text" class="input-text col-xs-12" name="age" id="age" datatype="n" readonly="readonly" ajaxurl="../checkworker.do">
	   </div>
		<div class="col-4"> <span class="Validform_checktip"></span></div>
     </li>
     <li class="clearfix">
      <label class="label_name col-xs-2 col-lg-2"><i class="c-red">*</i>性别：</label>
		<div class="Add_content col-xs-9">
		    <label><input type="radio" name="sex" class="ace" id="sex1" value="男" onclick="return false"><span class="lbl">男</span></label>
		    <label><input type="radio" name="sex" class="ace" id="sex2" value="女" onclick="return false"><span class="lbl">女</span></label>
	   </div>
		<div class="col-4"> <span class="Validform_checktip"></span></div>
     </li>
     <li class="clearfix">
				...
				<select class="select" name="workertype" size="1">
					...
					<c:forEach items="${workertype }" var="wt">
						<c:if test="${wt.getWorkerTypeId()!=1 }">
							<option value="${wt.getWorkerTypeId() }"><c:out value="${wt.getWorkerTypeName() }"></c:out></option>
						</c:if>
					</c:forEach>
					</c:if>					
				</select>
      ...
      <li class="clearfix">
		    ...
		    <div class="form-group">
		        ...
		        <div class="col-sm-9">
		            <input type="text" name="times" class="form-control laydate-icon" id="times" style=" height:30px;">
		        </div>
		    </div>
