...
<div class="margin add_administrator" id="page_style">
    ...
    <form action="../addsharepic.do" method="post" id="form-admin-add">
    <ul>
    	<li class="clearfix">
			<label class="label_name col-xs-2 col-lg-2">图片描述：</label>
		...
		<label class="label_name col-xs-2 col-lg-2">上传照片：</label>
			<p><input type="text" name="pic" id="url1" value="" /> <input type="button" name="workerpic" id="image1" value="选择图片" />（网络图片 + 本地上传）</p>
		</li>
         <li class="clearfix">
			<div class="col-xs-2 col-lg-2">&nbsp;</div>
			<div class="col-xs-6">
		  <input class="btn button_btn bg-deep-blue " type="submit" id="Add_Administrator" value="确认分享">
			</div>
		</li>
    </ul>
    </form>
