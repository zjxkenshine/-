...
<div class="margin Competence_style" id="page_style">
    ...
    <a  id="sharefile"  class="btn button_btn bg-deep-blue" title="分享文件"><i class="fa  fa-edit"></i>&nbsp;分享文件</a>
	<a  id="queryfile"  class="btn button_btn bg-deep-blue" title="搜索文件"><i class="fa  fa-search"></i>&nbsp;搜索文件</a>
...
<div class="compete_list">
     <table id="sample_table" class="table table_list table_striped table-bordered dataTable">
		 <thead>
			<tr>
             ...
             <c:forEach items="${sharefilelist }" var="share">
			  <tr>
                ...
                <td>
                <a title="下载" href="${share.getFileAddress()}" download=""  class="btn button_btn btn-green">下载</a>
                <c:if test="${share.getManagerId()==user.getManagerId()}">
               	 <a title="删除" href="javascript:;" onclick="Competence_del(this,${share.getShareFileId()})" class="btn button_btn btn-danger">删除分享</a></td>
			  	 </c:if>
			   </td>
			   </tr>
             </c:forEach>										
	        ...
	        <ul class="pagination">
	        <li class="first"><a href="../sharefilelist.do?nowPage=1">首页</a></li>
	        <li class="prev"><a href="../sharefilelist.do?nowPage=${page.nowPage<=1?1:page.nowPage-1}">上一页</a></li>
	        <li class="active"><a>第<c:out value="${page.nowPage }"></c:out>页</a></li>
	        <li class="next"><a href="../sharefilelist.do?nowPage=${page.nowPage>=page.totalpage?page.totalpage:page.nowPage+1}">下一页</a></li>
	        <li class="last"><a href="../sharefilelist.do?nowPage=${page.totalpage}">末页</a></li>
			...
			layer.confirm('确认要取消分享吗？',{icon:0,},function(index){
				...
				var nowpage=$("#nowpage").val();
					layer.open({
					    ...
					    ,maxmin: true //允许全屏最小化
					    ,anim: 2 //0-6的动画形式，-1不开启
					    ,content: '../deletesharefile.do?fileid='+id+"&count="+count+"&nowpage="+nowpage,
...
$("#pagesize").change(function(){
	...
	window.location.href="../updatepage.do?pagesize="+pagesize+"&pagename=文件共享表";
})

$("#pagejump").change(function(){
	var nowpage = $("#pagejump").val();
	window.location.href="../sharefilelist.do?nowPage="+nowpage;
})
</script>
