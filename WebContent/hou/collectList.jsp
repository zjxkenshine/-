 ...
 <table class="table table_list table_striped table-bordered" id="sample-table">
  ...
  <c:forEach items="${collect }" var="col">
    <tr class="main">
   		...
   		<td><c:out value="${col.getCollectId() }"></c:out></td>
   		<td><c:out value="${col.getGoodsId() }"></c:out></td>
   		<td><c:out value="${goodsname.get(col.getGoodsId()) }"></c:out></td>
   		<td><c:out value="${col.getClientId() }"></c:out></td>
   		<td><c:out value="${clientname.get(col.getClientId()) }"></c:out></td>
   		<td><c:out value="${col.getCollectTime() }"></c:out></td>
   	</tr>
  </c:forEach>
  </tbody>
 </table>
