...
<div class="margin add_administrator" id="page_style">
    ...
    <form action="../updateselfmessage.do" method="post" id="form-admin-add">
    <ul>
    <li class="clearfix">
     <label class="label_name col-xs-2 col-lg-2"><i>*</i>用户ID：</label>
     <div class="formControls col-xs-6">
     <input type="text" class="input-text col-xs-12" value="${user.getManagerId() }" placeholder="" id="managerid" name="managerid" readonly="readonly"></div>
    <div class="col-4"> <span class="Validform_checktip"></span></div>
     </li>
     <li class="clearfix">
     <label class="label_name col-xs-2 col-lg-2"><i>*</i>用户名：</label>
     <div class="formControls col-xs-6">
     <input type="text" class="input-text col-xs-12" value="${user.getManagerName() }" placeholder="" id="managername" name="managername" datatype="*2-16" nullmsg="用户名不能为空" ajaxurl="../checkmanager.do?managername=${user.getManagerName() }"></div>
    <div class="col-4"> <span class="Validform_checktip"></span></div>
     </li>
     <li class="clearfix">
      <label class="label_name col-xs-2 col-lg-2"><i class="c-red">*</i>邮&nbsp;箱：</label>
      <div class="formControls col-xs-6">
		<input type="text" class="input-text col-xs-12" value="${user.getE_mail() }" placeholder="@" name="e_mail" id="e_mail" datatype="e" nullmsg="请输入邮箱！" ajaxurl="../checkmanager.do?email=${user.getE_mail() }" >
	   </div>
		<div class="col-4"> <span class="Validform_checktip"></span></div>
     </li>
     <li class="clearfix">
      ...
      <div class="formControls col-xs-6"> <span class="select-box" style="width:150px;">
				<select class="select" name="status" size="1">
					<c:forEach items="${statuslist }" var="status">
						<c:if test="${status.getManagerStatusId()==user.getStatus() }"><option value="${status.getManagerStatusId() }" ><c:out value="${status.getManagerStatusName()}"></c:out></option></c:if>
					</c:forEach>
     ...
     <li class="clearfix">
      <label class="label_name col-xs-2 col-lg-2"><i class="c-red">*</i>员&nbsp;工id：</label>
      <div class="formControls col-xs-6"> <span class="select-box" style="width:150px;">
				<select class="select" name="workerid" size="1" datatype="*" nullmsg="请绑定一个员工">
					
					<option value="${worker.getWorkId() }" ><c:out value="${worker.getWorkId()}"></c:out></option>
				</select>
				</span>
         </div>
         <div class="col-4"> <span class="Validform_checktip"></span></div>
     ...
     <li class="clearfix">
			<label class="label_name col-xs-2 col-lg-2">管理员介绍：</label>
			<div class="formControls col-xs-6">
				<textarea name="discripe1" cols="" rows="" class="textarea col-xs-12" placeholder="说点什么...100个字符以内" dragonfly="true" onkeyup="checkLength(this);"><c:out value="${user.getDiscripe() }"></c:out></textarea>
    ...
    <div class="col-4"> <span class="Validform_checktip"></span></div>
      ...
      <div class="formControls col-xs-6"> <span class="select-box" style="width:150px;">
				<select class="select" name="workertype" size="1">
					<c:forEach items="${workertype }" var="wt">
							...
							<c:if test="${wt.getWorkerTypeId()==worker.getWorkerType() }">selected="selected"</c:if><option value="${wt.getWorkerTypeId() }" ><c:out value="${wt.getWorkerTypeName() }"></c:out></option>
     ...
     <li class="clearfix">
			...
			<div class="formControls col-xs-6">
				<textarea name="discripe2" cols="" rows="" class="textarea col-xs-12" placeholder="说点什么...100个字符以内" dragonfly="true" onkeyup="checkLength(this);"><c:out value="${worker.getDiscripe() }"></c:out></textarea>
				<span class="wordage">剩余字数：<span id="sy" style="color:Red;">100</span>字</span>
			</div>
		</li>
         <li class="clearfix">
