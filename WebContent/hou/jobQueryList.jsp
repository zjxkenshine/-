...
<div class="list_Exhibition margin-sx">
 <table class="table table_list table_striped table-bordered" id="sample-table">
  ...
  <tbody>
  <c:forEach items="${jobquery }" var="glq">
    <tr class="main">
   	  	<td class="center"><label><input btn_name="checkid" type="checkbox" class="ace" value=""><span class="lbl"></span></label></td>
   		<td><c:out value="${glq.getQueryId() }"></c:out></td>
   		<td><c:out value="${glq.getQueryString() }"></c:out></td>
   		<td><c:out value="${glq.getClientId() }"></c:out></td>
   		<td><c:out value="${clientname.get(glq.getClientId()) }"></c:out></td>
   		<td><c:out value="${glq.getAddTime() }"></c:out></td>
   	</tr>
  </c:forEach>
  </tbody>
 </table>
