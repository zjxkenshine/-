 ...
 <table class="table table_list table_striped table-bordered" id="sample-table">
  ...
  <c:forEach items="${shop }" var="sh">
    <tr class="main">
   		...
   		<td><c:out value="${sh.getShopId() }"></c:out></td>
   		<td><c:out value="${sh.getGoodsId() }"></c:out></td>
   		<td><c:out value="${goodsname.get(sh.getGoodsId()) }"></c:out></td>
   		<td><c:out value="${sh.getClientId() }"></c:out></td>
   		<td><c:out value="${clientname.get(sh.getClientId()) }"></c:out></td>
   		<td><c:out value="${sh.getAddTime() }"></c:out></td>
   	</tr>
  </c:forEach>
  </tbody>
 </table>
