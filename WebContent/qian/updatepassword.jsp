            ...
            <div class="indivterall">
                 <ul>
                 	<li class="indivterta"><p>个人中心</p>
               	    <div class="indivterta_til_onc"><a href="individual.html">我的订单</a> <a href="my_shop.html">我的收藏</a> <a href="../updatepasswordset.go">密码修改</a> <c:if test="${client.getStatus()==1 }"><a href="">我的商品</a> <a href="">售出订单</a> </c:if> </div></li>
                    <li class="link"></li>
              </ul>
            </div>
        </div>
    	<div class="right indivters">
    		<div class="indivters_til">
       	  ...
       	  <div class="indivters_pass">
       	  		<form action="../updateclientpassword.go" method="post" id="updpass"> 
            	<ul>
                	<li><span>原密码</span><input name="oldpass" id="oldpass" type="password" /></li>
                	<li><span>新密码</span><input name="newpass" id="newpass" type="password" /></li>
                	<li><span>确认新密码</span><input name="newpass2" id="newpass2" type="password" /></li>
                	<li><center><button type="submit">确定</button></center></li>
                </ul>
                </form>
            </div>
        </div>
