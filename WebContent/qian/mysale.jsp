    	...
    	<div class="right indivters">
    	 <p class="red">我的收藏</p>
        	<div class="indivters_all">
            	...
            	<ul>
            	<input id="orderid" type="hidden" value="${ord.getOrderId()}"> 	 	 	 	 	 	 	 	
                    ...
                    <li class="links"></li>
                	<li><c:if test="${ord.getStatus()==5 }"><a onclick="querentuikuan(this,${ord.getOrderId()})">确认退款</a></c:if></li>
                </ul>
            	</c:forEach>
         </div>
    </div>
...
<script>
	...
	function querentuikuan(obj,id){
		window.location.href="../changeorderstatus2.go?status=6&id="+id;
	}
