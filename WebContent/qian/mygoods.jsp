    	...
    	<div class="right indivters">
    	 <p class="red">我的收藏</p>
        	<div class="indivters_all">
            	...
            	<ul>
            	<input id="goodsid" type="hidden" value="${go.getGoodsId()}">  	 	 	 	 	 	 	 	
                	<li><p title="商品编号">${go.getGoodsId()}</p></li>
                    <li class="links"></li>
                	<li><p title="商品名字">${go.getGoodsName()}</p></li>
                    <li class="links"></li>
                    <li><p title="商品类型">${typename.get(go.getGoodsId())}</p></li>
                    <li class="links"></li>
                    <li><p title="商品价格">${go.getPrice()}</p></li>
                    <li class="links"></li>
                     <li><p title="商品所在地">${go.getLocation()}</p></li>
                    <li class="links"></li>
                     <li><p title="添加时间">${go.getAddTime()}</p></li>
                    <li class="links"></li>
                	<li><a id="deletegoods">删除</a><a href="../productallset.go?goodsid=${go.getGoodsId()} ">查看商品</a></li>
                </ul>
            	</c:forEach>
...
<script>
	...
	$("#deletegoods").click(function(){
		var id=$("#goodsid").val();
		window.location.href="../deletegoods.go?id="+id;
	})
