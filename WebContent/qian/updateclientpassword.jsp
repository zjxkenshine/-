...
<!--[if lt IE 9]>
  ...
  <![endif]-->
<body>
<form action="../updateclientpassword.go" id="addmanager">
...
<div class=" add_Competence_style margin" id="add_Competence_style">
   <ul class="add_style">
    ...
    <div class="formControls col-xs-6">
    	<input type="password" placeholder="密码" name="oldpassword" autocomplete="off" value="" class="input-text col-xs-12" datatype="*" nullmsg="原密码不能为空"  ajaxurl="../checkclientpassword.go">
    </div>
