...
<!---------------------produta-------------------------->
    ...
    <div class="shop-car">
       <div class="success">
       		...
       		<div class="d1" style="margin-left:370px;" >交易成功</div>
            <div class="d2">订单号 ： <c:forEach items="${orderlist }" var="ol">${ol }</c:forEach></div>
            <div class="d2">总价格 ：${sumprice}元</div>
          <a href="../shopcarset.go"> <div  style="background-color:#F47469; height:25px; width:100px; border-radius:5px; margin-left:400px; margin-top:50px; text-align:center; line-height:20px;"> 回到购物车</div> </a>
            <div class="d5"><a href="">订单详情</a> |<a href="../es_shop.go"> 继续购物</a></div>
       </div>
        <div class="cl"></div>
    </div>
<!---------------------foot-------------------------->
