...
/**
 * Servlet implementation class AddWorkerTypeServlet
 */
@WebServlet("/addworkertype.do")
public class AddWorkerTypeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddWorkerTypeServlet() {
        super();
