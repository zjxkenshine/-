...
/**
 * Servlet implementation class ResetWorkerQueryServlet
 */
@WebServlet("/resetworkerquery.do")
public class ResetWorkerQueryServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ResetWorkerQueryServlet() {
        super();
