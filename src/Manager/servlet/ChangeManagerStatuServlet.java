...
/**
 * Servlet implementation class ChangeManagerStatuServlet
 */
@WebServlet("/changemanagerstatus.do")
public class ChangeManagerStatuServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ChangeManagerStatuServlet() {
        super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			ms.changemanagerstatus(id,status);
			...
			mo.setDiscripe("修改了一条管理员状态，id="+id);
			os.addmanageroperation(mo);
			response.sendRedirect("managerlist.do?nowPage="+nowpage);
		}catch(Exception e){
