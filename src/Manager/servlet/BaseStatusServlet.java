...
/**
 * Servlet implementation class BaseStatusServlet
 */
@WebServlet("/updatebasestatusset.do")
public class BaseStatusServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BaseStatusServlet() {
        super();
