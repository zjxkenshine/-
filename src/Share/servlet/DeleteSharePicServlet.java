...
/**
 * Servlet implementation class DeleteSharePicServlet
 */
@WebServlet("/deletesharepic.do")
public class DeleteSharePicServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeleteSharePicServlet() {
        super();
...
try{
			...
			ss.deletesharepic(String.valueOf(id));
			...
			mo.setDiscripe("取消了一个图片分享,id="+id);
