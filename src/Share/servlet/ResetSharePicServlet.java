...
/**
 * Servlet implementation class ResetSharePicServlet
 */
@WebServlet("/resetsharepic.do")
public class ResetSharePicServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ResetSharePicServlet() {
        super();
