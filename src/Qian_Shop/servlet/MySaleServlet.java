...
/**
 * Servlet implementation class MySaleServlet
 */
@WebServlet("/mysale.go")
public class MySaleServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MySaleServlet() {
        super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			List<Order> lord=os.queryorderbysaleclient(cl.getClientId());
			...
			request.getRequestDispatcher("qian/mysale.jsp").forward(request, response);
